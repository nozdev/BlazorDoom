...
namespace ManagedDoom.SoftwareRendering
{
    public sealed class SfmlRenderer : IRenderer, IDisposable
    {
        ...
        public SfmlRenderer(IJSRuntime _JSRuntime, Config config, RenderWindow window, CommonResource resource)
        {
            try
            {
        ...
        private async void Display(uint[] colors)
        {
            // var watch = System.Diagnostics.Stopwatch.StartNew();
            ...
            await JSRuntime.InvokeAsync<string>("renderWithColorsAndScreenDataUnmarshalled", screen.Data, (int[])((object)colors));
