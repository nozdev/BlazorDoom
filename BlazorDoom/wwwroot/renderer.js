 ...
 */
window.renderWithColorsAndScreenDataUnmarshalled= function (screenData, colors) {
...
let soundSource;
window.playSound= function(samples, sampleRate, channel) {
 ...
 * @returns
 */
window.playMusic= function (samples, sampleRate, channel) {
